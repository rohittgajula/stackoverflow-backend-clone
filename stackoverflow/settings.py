...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": True,                      # Issue new refresh token on each usage
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('POSTGRES_HOST', 'localhost'),     # use 'db' when running on docker & '127.0.0.1' for local server
